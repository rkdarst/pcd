...
if 'all' in sys.argv:
    ...
    execfile('tests/testanneal.py', getglobals())
    ...
    execfile('tests/testHashOverlapMin.py', getglobals())
    execfile('tests/testkarateclub.py', getglobals())
    execfile('tests/testlattice.py', getglobals())
    execfile('tests/testoverlapmin.py', getglobals())
    execfile('tests/testtiming2.py', getglobals())

print "Done with unittests."
